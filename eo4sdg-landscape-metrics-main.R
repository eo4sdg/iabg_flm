...
# vietnam 1
# polygon_wkt<- "POLYGON((105.81481933593749 21.24074244508678,105.57037353515625 21.373802072095927,105.27374267578125 21.642111228517322,105.40557861328124 21.848752834673732,105.64178466796874 21.805408274177495,105.90270996093749 21.440286613700366,106.0235595703125 21.361013117950904,105.81481933593749 21.24074244508678))"

# vietnam 2
# polygon_wkt<- "POLYGON((107.01232910156246 10.360853210444702,106.51794433593747 11.208039579322019,106.38610839843746 11.695272733029398,106.39434814453124 12.012457514578045,106.93267822265625 12.219233387864023,107.34741210937497 12.42316552500995,107.46826171874997 12.283650121725415,108.25653076171872 11.372338792141122,108.48175048828124 11.008600512884058,108.3306884765625 10.879162225881402,108.11920166015625 10.873767739353795,108.02307128906251 10.644412463305883,107.86102294921875 10.660607953624776,107.61657714843749 10.520218543737045,107.3529052734375 10.393273105939045,107.25677490234374 10.336536087082976,107.1881103515625 10.336536087082976,107.07275390625 10.268978658034655,107.01232910156246 10.360853210444702))"
#
# # vietnam 3
# polygon_wkt<- "POLYGON((104.4140625 10.336536087082976,104.9853515625 11.005904459659448,105.77636718749999 11.070602913977822,105.64453124999999 11.910353555774094,107.31445312499999 12.533115357277154,107.40234375 13.45373721341926,107.20458984375001 14.30696949782579,107.40234375 15.32657180142084,108.6328125 15.813395760460594,109.53369140625 13.987376214146465,109.51171875 11.888853082975984,107.42431640625 10.098670120603401,107.11669921875 10.250059987303018,106.43554687499999 9.102096738726459,105.71044921874999 8.819938928283136,104.76562499999999 8.254982704877875,104.30419921875 8.450638800330992,104.47998046874999 9.015302333420607,104.67773437499997 9.925565912405503,104.4140625 10.336536087082976))"
#
# # ethiopia
# # ethiopia west side -> forest
# polygon_wkt<- "POLYGON ((35.827322 9.855216, 34.77785 9.909333, 34.151463 10.547221, 34.931699 11.775948, 36.124032 11.668376, 36.178978 10.412183, 36.00315 9.86604, 35.827322 9.855216))"

# Vietnam Andres Deliverable
polygon_wkt <- "POLYGON ((105.963135 17.668885, 105.963135 17.977427, 106.515198 17.977427, 106.515198 17.668885, 105.963135 17.668885))"
...
# world map
path$lc_raster <- "C:/Users/Cortes-Resendiz/Downloads/PROBAV_LC100_global_v3.0.1_2015-base_Discrete-Classification-map_EPSG-4326.tif"
...
aoi_name <- "andres_vietnam_deliverable"
aoi<- terra::vect(aoi)
rmarkdown::render(file.path(workflow_dir, glue::glue("flm_report.Rmd")),
       output_dir = out_dir,
       output_file = glue::glue("flm_report_{aoi_name}"),
       output_format = "all")

path$report_html <- file.path(out_dir, glue::glue("flm_report_{aoi_name}.html"))
path$report_pdf <- file.path(out_dir, glue::glue("flm_report_{aoi_name}.pdf"))
