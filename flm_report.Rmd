...
A table with all the metrics is shown at the end.
...
```{r}
# pkg_topic("terra", "mask")

```

```{r}
metrics_sections<- plot_files

foo<- purrr::map_chr(metrics_sections, get_i_filename)
...
#### Metric: `r get_i_filename(plot_files, 1)`
...
#### Metric: `r get_i_filename(plot_files, 2)`
...
#### Metric: `r get_i_filename(plot_files, 3)`
...
#### Metric: `r get_i_filename(plot_files, 4)`
...
#### Metric: `r get_i_filename(plot_files, 5)`
